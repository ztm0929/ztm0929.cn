...
- [x] 已安装 [Scoop](../../toolchain/package-managers/scoop/install)（Windows）或 [Homebrew](../../toolchain/package-managers/homebrew/install)（macOS）
- [x] 已安装 [Python](../../toolchain/python/install) 和 [uv](../../toolchain/python/uv/install)

## 动脑思考

我们的完整项目文件夹内将会有以下文件
```text title="szu-venue-helper"
README.md
src/main.py
src/config.py
src/models.py
src/api/client.py
src/api/venue_query.py
src/api/venue_booking.py
src/service/booking_flow.py
src/scripts/fetch_cookies.py
src/scripts/download_venue_data.py
```
